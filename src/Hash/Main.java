...
//        myHash.printAllSlot();
         ...
         *
         * Chaining 기법 : 충돌이 일어나는 공간 뒤에 또 다른 Linked List를 만듬 그래서 Open,개방 용어가 붙음
         * Linear Probing 기법 : 충돌 발생시 추가 공간을 만드는것이 아닌 다른 빈 슬롯을 규칙에 따라 찾아서 저장  그래서 폐쇠,Close 용어가 붙음
         *
         */
